...
class ScoreBetModel(Base):
    ...
    match_id: Mapped[UUID] = mapped_column(
        UUIDType(binary=False), sa.ForeignKey("match.id"), nullable=False
    )
...
class BinaryBetModel(Base):
    ...
    id = mapped_column(UUIDType(binary=False), primary_key=True, nullable=False, default=uuid4)
...
class MatchModel(Base):
    ...
    user: Mapped[list[UserModel]] = relationship("UserModel", foreign_keys=user_id)
