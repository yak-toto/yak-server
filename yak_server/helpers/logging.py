...
def modify_score_bet_successfully(
    ...
    return (
        f"{user_name} modify "
        f"{original_bet.match.team1.description_fr}-{original_bet.match.team2.description_fr} "
        f"in {original_bet.match.group.description_fr} "
...
def modify_binary_bet_successfully(
    ...
    return (
        f"{user_name} modify "
        f"{original_bet.match.team1.description_fr if original_bet.match.team1 else None}"
        f"-{original_bet.match.team2.description_fr if original_bet.match.team2 else None} "
        f"in {original_bet.match.group.description_fr} "
